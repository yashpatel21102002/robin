                                ...
                                <FormItem className="col-span-12 lg:col-span-10 ">
                                    <FormControl className="m-0
                                     p-0">
                                        ...
                                        placeholder = "How do I calculate the radium of a circle?"
                                        {...field}
                                        />
                                     </FormControl>
                                </FormItem>
                    ...
                    <div className="flex flex-col-reverse gap-y-4">
                        {
                            messages.map((message)=>(
                                ...
                                className={cn("p-8 flex w-full items-start gap-x-8 rounded-lg",message.role === "assistant" ? "bg-white border border-black/10 ":"bg-muted")}>
